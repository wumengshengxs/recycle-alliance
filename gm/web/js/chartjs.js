...
$(function() {
  var ctx, data, myBarChart, option_bars;
  Chart.defaults.global.responsive = true;
  if($('#radar-chart').get(0) == undefined){
    return false;
  }
...
$(function() {
  ...
  Chart.defaults.global.responsive = true;
  if($('#polar-area-chart').get(0) == undefined){
    return false;
  }
...
$(function() {
  var ctx, data, myLineChart, options;
  Chart.defaults.global.responsive = true;
  if($('#jumbotron-line-chart').get(0) == undefined){
    return false;
  }
