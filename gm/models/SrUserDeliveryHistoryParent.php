...
/**
 * This is the model class for table "sr_user_delivery_history_parent".
 *
 * @property string $id 主键ID
 * @property int $agent_id 所属运营商id
 ...
 */
class SrUserDeliveryHistoryParent extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'sr_user_delivery_history_parent';
    }
    ...
    {
        return [
            [['agent_id', 'machine_id', 'total_points', 'user_id'], 'integer'],
            [['machine_id', 'user_id', 'serial_num'], 'required'],
