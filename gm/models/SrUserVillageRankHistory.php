 ...
 * @property string $week_day_delivery_weight 截止当日周度总重量
...
class SrUserVillageRankHistory extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['day_delivery_income', 'day_delivery_weight', 'month_day_delivery_income', 'month_day_delivery_weight', 'week_day_delivery_income', 'week_day_delivery_weight'], 'number'],
            [['update_date'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'week_day_delivery_weight' => 'Week Day Delivery Weight',
