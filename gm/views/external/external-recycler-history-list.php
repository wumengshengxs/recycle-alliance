<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">回收商<?=$recyclers['nick_name']?></h2>
            ...
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item " aria-current="page"><a href="/external/external-recycler-index" class="breadcrumb-link">回收商管理</a></li>
...
<script>
    ...
    $(function(){
        ...
        var url = '/external/ajax-external-recycler-history-list?id='+id;
        var params = {};
    ...
    $('#search').click(function(){
        ...
        var url = '/external/ajax-external-recycler-history-list';
        window.dataTable(params, url);
    });
