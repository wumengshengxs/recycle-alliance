...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">收货量统计</h2>
            <p class="pageheader-text"></p>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/" class="breadcrumb-link">首页</a></li>
                        <li class="breadcrumb-item active" aria-current="page">收货量统计</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<script>
    ...
    $('#search').click(function(){
        ...
        window.location.href = '/external/recycler-order-amount?'+params;
    });
