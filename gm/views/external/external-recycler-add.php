...
<div class="card" style="margin-bottom:0px">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <input type="text" id="nick_name" value="" class="form-control col-12"/>
        </div>
        <div class="row">
            <div class="area-title">手机号</div>
            <input type="text" id="phone_num"  maxlength="11"  value="" class="form-control col-12"/>
        </div>
        ...
        <div class="row ">
            ...
            <div class="form-control col-12" style=" border: 0px">
                <label class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="status"  value="0" class="custom-control-input"><span class="custom-control-label">失效</span>
                </label>
                <label class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="status" checked="" value="1" class="custom-control-input"><span class="custom-control-label">生效</span>
                </label>
        ...
        Dialog({
            ...
            ok: {
                callback: function() {
                    ...
                    $.ajax({
                        url: '/external/external-recycler-add',
                        type: 'post',
                        data: data,
                        dataType: 'json',
