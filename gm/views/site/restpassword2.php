...
<body>
    ...
    <div class="splash-container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/site/restpassword" onsubmit="return validate()" method="post">
                    <p>重置密码</p>
                    <div class="form-group">
                        <input class="form-control form-control-lg" type="password" id="password" name="password" required placeholder="密码" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <input class="form-control form-control-lg" type="password" id="repassword" name="repassword" required placeholder="确认密码" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <p id="error" class="">两次输入密码不一致</p>
                    </div>
                    <div class="form-group pt-1">
                        <input type="submit" name="next" id="next" class="btn btn-block btn-primary" value="确定">
                    </div>
