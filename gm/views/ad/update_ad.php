        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="inputName" class="col-sm-1 col-md-2 col-lg-2 control-label">
                   <!-- <span style="color: red">*</span>--> 编辑广告名称:
                </label>
                <label class="col-sm-6 col-md-5 col-lg-5 ">
                    <input type="text" name="ad_name" value="<?=$temp['name']?>" id="ad_name"
                           class="form-control"
                           onfocus="if(this.placeholder == '如：云贵三日游广告') this.placeholder = ''"
                           onblur="if(this.placeholder =='') this.placeholder = '，如：云贵三日游广告'"
                           placeholder="如：云贵三日游广告">
                </label>
            </div>
            <div class="form-group">
                <label for="inputName" class="col-sm-1 col-md-2 col-lg-2 control-label" style="vertical-align: top">
                    <!--<span style="color: red">*</span>--> 修改广告图:
                </label>
                <label class="col-sm-10 col-md-5 col-lg-5  " id="container" style="vertical-align: top" >
                    <div class="flex-start" onclick="return false" >
                        <div class="" id="selectfiles" style="height: auto;margin-right: 15px;"><a
                                ...
                                <img id="avatarPreview" src="<?=$temp['img']?>"
                                     title="点击更换图片"
            ...
            <div class="form-group" id="">
                ...
                <label class="col-sm-6 col-md-5 col-lg-5 ">
                    <input type="text" name="ad_resolution_ratio" value="<?=$temp['stay_time']?>"
                           id="ad_time"
                           class="form-control">
                </label>
           ...
           <!-- <div class="form-group" id="">
                <label for="inputName" class="col-sm-1 col-md-2 col-lg-2 control-label">
                    <span style="color: red"></span> 广告跳转连接:
                </label>
                <label class="col-sm-6 col-md-5 col-lg-5 ">
            ...
            <div class="form-group" id="">
                ...
                <label class="col-sm-6 col-md-5 col-lg-5 ">
                    <input type="text" name="top_sort" value="<?=$temp['top_sort']?>" id="top_sort"
                           class="form-control"
                           onfocus="if(this.placeholder == '数字越小排序越靠前,0为最靠前的数字') this.placeholder = ''"
                           onblur="if(this.placeholder =='') this.placeholder = '数字越小排序越靠前,0为最靠前的数字'"
                           placeholder="数字越小排序越靠前,0为最靠前的数字">
                </label>
            </div>
...
<script>
    ...
    function ad_save() {
        ...
        var avatarPreview = $("#avatarPreview").attr('src');
        var ad_time = $('#ad_time').val();//广告停留时间
        var img_urls = $('#top_sort').val();//广告排列顺序
        ...
        var data = {
            ...
            img_urls: avatarPreview,//广告位缩略图
            id :id,//广告id
            ad_time:ad_time,//轮播停留时间
            top_sort:top_sort,//广告排序
            "_csrf-gm": "<?=Yii::$app->request->csrfToken?>"
        }
        $.ajax({
            url: '/ad/ajax_update_ad',//编辑广告
            type: 'get',
            data: data,
            dataType: 'json',
