                                    ...
                                    <div class="switch" style="">
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-8 col-lg-9 ">
                                                    <input type="text" name="mark" value="" id="mark" class="form-control" placeholder="备注">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputName" class="col-sm-2 col-md-4 col-lg-3 control-label">
...
<script>
    ...
    function recycl_change() {
        ...
        var type = $('#type').val()
        var mark = $('#mark').val()
        var r = confirm("确定该订单是恶意投递吗？系统会实时扣除用户的环保金、提交后无法修改审核结果。是否提交？")
        if (r != true) {
    ...
    var uploader = new plupload.Uploader({
        ...
        init: {
            ...
            FileUploaded: function(up, file, info) {
                if (info.status == 200)
                {
                    document.getElementById(file.id).getElementsByTagName('b')[0].innerHTML = '<img href="' + host + get_uploaded_object_name(file.name) + '" width="50" height="50">';
                    if (img_urls == '') {
